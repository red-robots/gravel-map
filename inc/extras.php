...
function add_route_to_api( $args, $post_type ) {
    if ( 'route' === $post_type ) {
        $args['show_in_rest'] = true;
    }
    return $args;
}
add_filter( 'register_post_type_args', 'add_route_to_api', 10, 2 );

function add_route_type_to_api( $args, $taxonomy ) {
    if ( 'route-type' === $taxonomy ) {
        $args['show_in_rest'] = true;
    }
    return $args;
}
add_filter( 'register_taxonomy_args', 'add_route_type_to_api', 10, 2 );
